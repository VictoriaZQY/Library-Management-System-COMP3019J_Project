...
- Lost and Found: If users lose items in the library or during the borrowing process, they can submit item information through the lost and found feature for other users to view and contact the owner. And it’s the same case with the users or staff who found something they thought being left behind. This function aims to enhance interaction and support among users.
...
There is one screenshot for the administrator/staff/student to log into the system.
<img width="1280" height="800" alt="image" src="https://github.com/user-attachments/assets/5bbe3746-8ad0-49dd-a1e4-bfba56bd0139" />
#### Editing Login Information Process:
1. **Log in the account:** Users select their identity as either an administrator, staff, or student by choosing "identification," fill in their email and password to access the system.
#### Cancel Login Process:
1. **Cancel Login the information:** Users fill in the information about the account, and users click the 'Cancel' button to cancel the login process for the account.
...
There are two screenshots for administrators/staff/students to register in the system.
<img width="1280" height="800" alt="image" src="https://github.com/user-attachments/assets/171a4826-4cfc-44e4-8269-64df39dcfc12" />
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/3026203f-c8e5-4316-ba4a-742e49b98eb2" />
...
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/64785b8c-694d-4e35-9d78-de51f77120f2" />
...
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/53d701b8-d993-4f18-ad92-66cedbb9e51a" />
...
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/e11f1b41-3f5c-4fe9-bbf2-d0ec81109a21" />
#### Change Personal Information Items: 
...
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/11bca5f5-0064-4aeb-8a49-a317eac937dd" />
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/72114bee-1ed6-4e27-9843-d2faeb720c9d" />
...
2. **Viewing and Editing Book Information:**
   ...
   - Changes are likely to be made to update book information, adjust inventory numbers, or correct existing data.
...
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/85e7323b-fd0c-41a9-bfd5-33629081a383" />
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/3a0a00b9-cf54-4a8e-966b-cf0ae7ec7b6a" />
...
### Lost and Found Section for Staff
The section helps staff manage lost and found reports as well as update the status of items.
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/74b5122a-8553-4402-890c-5b397f4f0af7" />
<img width="1280" height="800" alt="image" src="https://github.com/user-attachments/assets/86c83638-1851-425e-9c60-cc0b7f7c644a" />
...
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/ac2aee9d-84ac-4708-b934-3855faec067c" />
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/033733cf-14d6-4d7f-be9d-1c7d0d162734" />

#### Send Message:
  - Students can communicate with staff through the messaging feature.
...
#### View Message:
  ...
  - Students can view the details of those messages and their replies.

#### Reply Message:
  - Students have the ability to respond to messages from students or staff.
...
### Messaging Feature for Staff
There are two screenshots for staff to send messages on the board.
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/f9295015-0030-43f0-bf2f-26892addcf6f" />
<img width="5334" height="3334" alt="image" src="https://github.com/user-attachments/assets/0f7318ae-d488-47d0-8705-90882b0fe97d" />
...
#### General Interface Elements:
1. **Check Button:** The "Check" button enables staff to view detailed information, responses.
2. **Send Button:**  This button allows staff to reply to students' messages on the detail pages.
3. **Return Button:**  All detailed pages have a "Return" button allowing staff to go back to the previous menu or main page.



## DataBase Design
There is an Entity-Attribute Diagram for the Library Management System Database
<img width="1068" height="1065" alt="image" src="https://github.com/user-attachments/assets/44b0aa68-317b-41ad-9703-5f70fc719a80" />
1. Administrator:
